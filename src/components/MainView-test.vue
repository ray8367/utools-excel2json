<template>
  ...
  >
    ...
    >
      ...
      <div ref="resultOutRefs" class="flex flex-1">
        <a-resize-box
          :directions="['top']"
          :style="{
            minHeight: resultHeight * (2 / 3) + 'px',
            maxHeight: '100%',
            height: resultHeight + 'px'
          }"
          @moving="setResultHeight"
        >
...
function setResultHeight() {
  console.log('设置结果容器的高度')
  const height = resultOutRefs.value.clientHeight
