...
.btn_main {
  ...
  @apply transition-all flex-c w-120px h-36px relative overflow-hidden rounded-4px bg-white shadow-lg hover:shadow-md active:shadow-sm dark:(bg-dark-400 text-shadow-xl shadow-dark-800);
}
